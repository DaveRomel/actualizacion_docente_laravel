...
@section('contenido')
        ...
        <div class="content-area">
            ...
            <div class="inscription-card">
                ...
                <h2>Inscripción - Electrónica</h2>
                <p>Nombre: {{$currentUser['name']}}</p>
                <p>Institución: {{$currentUser['procedencia']}}</p>
                {{-- PASO 1.1: Agrega un ID al formulario --}}
                <form id="inscriptionForm" action="{{ url('/inscribir-usuario/' . $currentUser['id'] .'/8') }}" method="post">
                    @csrf
            ...
            <div class="reminder-card" data-materia-id="8">
